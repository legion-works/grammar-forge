...
// service fails OPEN when no verifier is configured, when the repaired text
// equals the original, or when the verifier errors; the gate only ever
// blocks on a confident low-similarity score.
